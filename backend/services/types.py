...
class UnsignedTxResponse(BaseModel):
    """
    Unsigned transaction trả về cho frontend ký.
    Compatible với ethers.js v6 và viem.
    """
    ...
    chainId: int
    value: int = 0
    gasPrice: Optional[int] = None  # legacy
    maxFeePerGas: Optional[int] = None  # EIP-1559
    maxPriorityFeePerGas: Optional[int] = None  # EIP-1559
