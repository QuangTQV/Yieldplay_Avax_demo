...
class Season(Base):
    ...
    base_reward_pool: Mapped[float] = mapped_column(Numeric(18, 6), default=0)
    ...
    yieldplay_pool_id: Mapped[str | None] = mapped_column(String(100), nullable=True)
    created_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), default=utc_now)
...
class YieldPlayLog(Base):
    __tablename__ = "yieldplay_log"
